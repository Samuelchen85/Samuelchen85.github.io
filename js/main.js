...
var main = (function () {
    ...
    var configs = (function () {
        ...
        Singleton.defaultOptions = {
            ...
            myip_help: "Show your current ip address and area.",
            welcome: "Welcome to Samuel's website:)\n\nIn order to get started, simply use command 'ls' to show all the files, and use command 'cat xxx.txt' to see the details. Feel free to either execute the 'help' command or use the more user-friendly colored sidenav at your left.\nIn order to skip text rolling, double click/touch anywhere.",
